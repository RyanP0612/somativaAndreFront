      ...
      <h1>
        ...
        <section v-if="mostrar">
            ...
            <section v-for="stts in sttsFound.data" :key="stts.id"> 
              ...
              <h4 v-if="stts.idTarefaFK == teste">Nome: {{ stts.idStatusFK.nome }} / Data: {{ stts.data }} / Descrição: {{ stts.descricao }}</h4>
            </section>
            <!-- <h4 v-for="stts in sttsFound.data.idTarefaFK == teste" :key="stts.id">  / Data: {{ stts.data.data }} / Descrição: {{ stts.data.descricao }}</h4> -->
